...
let tools = [
    ...
    },
    {
        ...
        desc: "Выбрать начальную и конечную вершины для запуска 'Алгоритм Дейсткры'. Завершить работу с алгоритмом - кнопка 'Завершить'.", 
                    ...
                    while(true){
                        ...
                        for (let idx = si; idx < list[curr].length; idx++){
                            ...
                            if (!visited[i]){
                                ...
                                after = "Найдена смежная непосещенная вершина " + currGraph.Vs[i].name + ". Прерываем просмотр для вершины " + currGraph.Vs[curr].name + ". Возвращаем текущую веришу в стек. " + getStack(stack, "push", curr);
                                player.push(
                                    Step.getSteps([
    ...
    {
        name: "Алгоритм Прима", 
        desc: "Выбрать начальную вершину для запуска 'Алгоритм Прима'. Завершить работу с алгоритмом - кнопка 'Завершить'.", 
        src: "Icons/MST.svg", 
        action: (e) => {
    ...
    },
    {
        ...
        desc: "Выбрать начальную (исток) и конечную (сток) вершину для запуска 'Алгоритм Форда-Фалкерсона'. Завершить работу с алгоритмом - кнопка 'Завершить'.", 
        ...
        action: (e) => {
                if (currSelected && lastSelected && 
                    ...
                    let before = "Алгоритм запущен.";
                    let after = "Преобзразуем граф. Ребра представим в виде пар дуг одинакового веса. Непарным дугам добавим возвратные дуги веса 0. Изначально максимальный поток 0.";
                    player.push(
                        Step.getSteps([
                            new TextSegment(myAlert, after, before)
                        ])
